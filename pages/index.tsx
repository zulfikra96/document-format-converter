        ...
        <div className="container mx-auto">
          <div className="flex flex-row">
            <div className="flex-1  p-4">
              <textarea className="w-full" onChange={(val) => this.setState({value:val.target.value})} placeholder="CSV String" name="" id="" cols={30} rows={20}></textarea>
            </div>
            <div className="flex-1  p-4">
            <textarea className="w-full" placeholder="Result" readOnly={true} value={JSON.stringify(this.state.results,undefined,4)} name="" id="" cols={30} rows={20}></textarea>
            </div>
          </div>
          <div className="flex flex-row">
